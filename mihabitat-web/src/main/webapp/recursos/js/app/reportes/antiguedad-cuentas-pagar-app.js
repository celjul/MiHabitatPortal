var AntiguedadCuentasPagarViewModel = function() {
    ...
    self.reporte = new AntiguedadCuentasPagar();
    ...
    self.consulta = function() {
        ...
        if (self.valida()) {
            $.ajax({
                cache : false,
                url: contextPath + "/administrador/reportes/antiguedad-cuentas-pagar/consultar",
                data : {
                    tipo: self.tipo(),
    ...
    self.imprimir = function(formato) {
        if (self.valida()) {
            var url = contextPath + "/administrador/reportes/antiguedad-cuentas-pagar/imprimir?formato=" + formato 
                + "&tipo=" + self.tipo()
