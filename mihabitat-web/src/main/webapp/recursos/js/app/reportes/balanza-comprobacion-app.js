var BalanzaComprobacionViewModel = function(data) {
    
    var self = this;
    
    self.reporte = new BalanzaComprobacion();
    ...
    self.consulta = function() {
        ...
        if (self.valida()) {
            $.ajax({
                cache : false,
                url: contextPath + "/administrador/reportes/balanza-comprobacion/consulta",
                data : {
    ...
    self.imprimir = function(formato) {
        if (self.valida()) {
            var url = contextPath + "/administrador/reportes/balanza-comprobacion/imprimir"
                + "?formato=" + formato 
