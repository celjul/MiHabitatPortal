/*! SmartAdmin - v1.4.1 - 2014-06-22 */!function(a) {
    a.extend(a.fn, {validate: function(b) {
        ...
        return 1 === arguments.length ? function() {
        ...
        }, messages: {required: "This field is required", remote: "Please fix this field", email: "Please enter a valid email address", url: "Please enter a valid URL", date: "Please enter a valid date", dateISO: "Please enter a valid date (ISO)", number: "Please enter a valid number", digits: "Please enter only digits", creditcard: "Please enter a valid credit card number", equalTo: "Por favor introduce el mismo valor nuevamente.", greaterThan: "Por favor, capture un valor mayor.", maxlength: a.validator.format("Please enter no more than {0} characters"), minlength: a.validator.format("Please enter at least {0} characters"), rangelength: a.validator.format("Please enter a value between {0} and {1} characters long"), range: a.validator.format("Please enter a value between {0} and {1}"), max: a.validator.format("Please enter a value less than or equal to {0}"), min: a.validator.format("Please enter a value greater than or equal to {0}")}, autoCreateRanges: !1, prototype: {init: function() {
                function b(b) {
            ...
            a.validator.methods[b] = c, a.validator.messages[b] = void 0 !== d ? d : a.validator.messages[b], c.length < 3 && a.validator.addClassRules(b, a.validator.normalizeRule(b))
                ...
                var a1 = Number(a);
                var c1 = Number(c);
                if(isNaN(a1) || isNaN(c1)) {
                    return this.optional(b) || a >= c;
                } else {
                    return this.optional(b) || a1 >= c1;
                }
            }, max: function(a, b, c) {
                var a1 = Number(a);
                var c1 = Number(c);
...
//                  return this.optional(b) || a >= $(c).val();
            	return this.optional(b) || parseFloat(a) >= $(c).val();
