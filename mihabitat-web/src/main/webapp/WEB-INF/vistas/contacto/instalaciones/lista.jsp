...
<head>
	...
	<link href="${pageContext.request.contextPath}/recursos/css/portfolio.css" rel="stylesheet">
</head>
<body>
	<div id="ribbon">
		<ol class="breadcrumb">
			<li><a
				href="${pageContext.request.contextPath}/contacto/inicio?condominio=${condominio.id}">
					<spring:message code="mihabitat.menu.inicio" />
			</a></li>
			<li><a
				href="${pageContext.request.contextPath}/contacto/instalaciones/lista">
						...
						<div class="row margin-bottom-40">
							...
							<div class="col-md-12 col-sm-12">
								<div class="well well-sm" data-bind="visible: $root.instalaciones().length == 0">
									No se han agregaro Instalaciones o Áreas de uso Común para este condominio. Consulte con su Administrador para registrar instalaciones y poder hacer reservaciones sobre ellas
								</div>
											...
											<div class="col-md-3 col-sm-4 col-xs-12 mix mix_all"
												...
												<div class="mix-inner">
													...
													<div class="mix-details">
														...
														<a class="mix-preview fancybox-button" data-bind="click: $root.reservarContacto"
	...
	<script src="${pageContext.request.contextPath}/recursos/js/app/portfolio.js?v=${project-version}"></script>
