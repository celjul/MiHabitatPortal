...
<body>
	<div id="ribbon">
		<ol class="breadcrumb">
			...
			<li><a
				href="${pageContext.request.contextPath}/contacto/blogs/lista">
	...
	<%--<script type="text/javascript">
		var config = {
			...
			meses : "<spring:eval expression="@propertyConfigurer.getProperty('meses.descripcion')" />".split(',')
		};
	</script>--%>
	<script
	...
	<script
			src="${pageContext.request.contextPath}/recursos/js/app/portfolio.js"></script>
	<script
			src="${pageContext.request.contextPath}/recursos/js/plugin/bootstrap-datetimepicker/moment.min.js"></script>


	<script
			src="${pageContext.request.contextPath}/recursos/js/app/blogs/blogs-app.js"></script>
