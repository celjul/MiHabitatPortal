		...
		<div 
			...
			<div>
				...
				<div class="widget-body no-padding">
					<form action = "${pageContext.request.contextPath}/contacto/arrendamiento/update" onsubmit="return validateMyForm();" method = "POST" id="arrendatario-form" class="smart-form">
						<fieldset>
							<section class="row">
