		...
		<div 
			...
			<div>
				...
				<div class="widget-body no-padding">
					<form action = "${pageContext.request.contextPath}/contacto/arrendamiento/guardar" onsubmit="return validateMyForm();" method = "POST" id="arrendatario-form" class="smart-form">
						<fieldset>
							<section class="row">
							...
							<section class="row">
									...
									<label class="label">
									<spring:message code="mihabitat.menu.arrendamiento.fechaentrada"/></label>
									 <div class="input-group date" data-provide="datepicker">
    									<input id="fechaEntrada" name="fechaEntrada" type="date" required="required" class="form-control">
									...
									<spring:message code="mihabitat.menu.arrendamiento.fechasalida"/>
									 ...
									 <div class="input-group date" data-provide="datepicker">
    									<input id="fechaSalida" name="fechaSalida" type="date" required="required" class="form-control">
   	 										<div class="input-group-addon">
        										<span class="glyphicon glyphicon-th"></span>
   											 </div>
									</div>
						...
						<footer>
							<button type="submit" id="botonRegistro" name="botonRegistro" class="btn btn-primary"> 
...
$(document).ready(function(){
	if(${statusguardado==1}){ 
	notificacionExito('Se registro con exito');}
