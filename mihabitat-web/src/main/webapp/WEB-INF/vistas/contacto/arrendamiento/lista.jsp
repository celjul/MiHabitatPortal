...
<body>
	<div id="ribbon">
		<ol class="breadcrumb">
			...
			<li>
			   <a href="${pageContext.request.contextPath}/contacto/departamentos/lista">
	...
	<form name="myform" id="myform" action="${pageContext.request.contextPath}/contacto/arrendamiento/actualizar" method = "POST">
