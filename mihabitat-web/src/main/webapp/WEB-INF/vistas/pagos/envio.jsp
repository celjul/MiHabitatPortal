...
<div id="envio-modal" class="modal fade pagos" tabindex="-1" data-width="500">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><spring:message code="mihabitat.pago.enviar" /></h4>
            </div>
            <div class="modal-body">
                <form id="envio-form" class="smart-form">
                    <fieldset>
		                    ...
		                    <div class="col-sm-12 col-md-12 col-lg-12">
			                        ...
			                        <thead>
			                            <tr>
			                                ...
			                                <th data-class="expand" class="col-md-2"><spring:message code="mihabitat.pago.enviar" /></th>
			                            </tr>
			                        </thead>
		                ...
		                <div class="row">
		                    <div class="col-sm-12 col-md-12 col-lg-12">
		                        <label class="label"><spring:message code="mihabitat.pago.enviar.otros" /></label>
		                ...
		                <div class="row">
		                    <div class="col-sm-12 col-md-12 col-lg-12">
		                        <label class="label"><spring:message code="mihabitat.pago.enviar.mensaje" /></label>
