          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="text-center error-box">
                <h1 class="error-text-2" style="font-size: 45px"> PROXIMAMENTE </h1><br>
                <h2 class="font-xl"><strong>
                  <i class="fa fa-fw fa-clock-o fa-lg txt-color-orangeDark"></i> Pronto estará listo.</strong></h2>
                <br />
                <p class="lead">
                  Estamos trabajando duro para tener listo esto para ti. Disculpa las molestias. Si tienes dudas contactanos a
                  <a href="mailto:hola@mihabitat.com.mx" style="cursor: pointer">hola@mihabitat.com.mx</a>.
                </p>
                <p >
