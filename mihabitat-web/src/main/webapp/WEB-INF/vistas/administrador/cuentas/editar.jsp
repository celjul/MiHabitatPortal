...
<head>
	<title><spring:message code="mihabitat.menu.cuentas"></spring:message> | <spring:message code="mihabitat.nombre"/></title>
	...
	<div id="ribbon">
        <ol class="breadcrumb">
           <li>
			...
			<li>
				<a href="${pageContext.request.contextPath}/administrador/cuentas/lista">
