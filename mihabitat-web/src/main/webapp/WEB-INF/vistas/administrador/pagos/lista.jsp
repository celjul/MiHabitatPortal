    ...
    <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false">
        <header>
            ...
            <div class="widget-toolbar">
                <a href="${pageContext.request.contextPath}/administrador/pagos/nuevo" class="btn btn-success"> <i
                        class="fa fa-plus-circle"></i> Agregar Pago </a>
            </div>
        </header>
        <div>
            ...
            <div class="widget-body no-padding">
                <table id="table-pagos" class="table table-striped table-bordered table-hover" style="width: 100%">
                    <thead>
                    <tr>
                        <th class="hasinput" style="width: 5%;">
                            <input type="text" class="form-control"
                                   placeholder="<spring:message code="mihabitat.pago.folio" />"/>
                        </th>
                        <th class="hasinput" style="width: 10%;min-width: 50px;">
                        </th>
                        <th class="hasinput" style="width: 15%;">
                            <input type="text" class="form-control"
                                   placeholder="<spring:message code="mihabitat.contacto" />"/>
                        </th>
                        <th class="hasinput" style="width: 15%;">
                            <input type="text" class="form-control"
                                   placeholder="<spring:message code="mihabitat.departamento" />"/>
                        </th>
                        <th class="hasinput" style="width: 10%;">
                            <input type="text" class="form-control"
                                   placeholder="<spring:message code="mihabitat.pago.metodo" />"/>
                        </th>
                        <th class="hasinput" style="width: 5%;">
                            <input type="text" class="form-control"
                        ...
                        <th class="hasinput" style="width: 20%;">
                            <input type="text" class="form-control"
                                   placeholder="<spring:message code="mihabitat.pago.comentario" />"/>
                        </th>
                        <th class="hasinput" style="width: 5%;">
                    ...
                    <tr data-bind="css: {'': (estatus[estatus.length - 1].estatus.id == AppConfig.catalogos.estatuspago.aprobado),
                        ...
                        <td >
                            <span class="label pull-left label-warning" style="color: white;white-space: normal" data-bind="text: metodoPago.descripcion, visible: metodoPago.id == AppConfig.catalogos.metodos.saldofavor">
                            </span>
