...
<body>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget" id="wid-id-1">
                    <header>
                        ...
                        <h2>
                            <spring:message code="mihabitat.reportes.antiguedadcuentasporcobrar" />
                        </h2>
                    </header>
                    <div>
	...
	<script src="${pageContext.request.contextPath}/recursos/js/app/reportes/antiguedad-cuentas-cobrar-app.js?v=${project-version}"></script>
	<script type="text/javascript">
		$(function() {
			var viewModel = new AntiguedadCuentasCobrarViewModel();
