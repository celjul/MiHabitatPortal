...
<body>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget" id="wid-id-1">
                    <header>
                        ...
                        <h2>
                            <spring:message code="mihabitat.reportes.cuentasporpagar" />
                        </h2>
                    </header>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="row">
		                                ...
		                                <div class="col col-md-4">
		                                    <label class="label">
		                                        <span class="error-required">*</span><spring:message code="mihabitat.reportes.cuentasporpagar.fin" />
		                                    </label>
		                                    <input class="form-control" type="text" name="fin" id="fin" 
		                                        placeholder="<spring:message code="mihabitat.reportes.cuentasporpagar.fin" />"
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="table-responsive">
	                                    <table id="table-cuentas-cobrar" class="table table-striped table-bordered" style="width: 100%">
	                                        <thead>
	                                            <tr>
	                                                <th data-class="expand" class="col-sm-6 col-md-6 col-lg-6"><spring:message code="mihabitat.reportes.cuentasporpagar.proveedor" /></th>
	                                                <th data-class="expand" class="col-sm-3 col-md-2 col-lg-3"><spring:message code="mihabitat.reportes.cuentasporpagar.saldo" /></th>
	                                                <th data-class="expand" class="col-sm-3 col-md-2 col-lg-3"><spring:message code="mihabitat.reportes.cuentasporpagar.antiguedad" /></th>
	                                            </tr>
	                                        </thead>
	                                        <tbody>
    ...
    <script src="${pageContext.request.contextPath}/recursos/js/app/reportes/cuentas-pagar-app.js?v=${project-version}"></script>
    <script type="text/javascript">
        $(function() {
            var viewModel = new CuentasPagarViewModel({
                fin : ${fin}
            });
