...
<body>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget" id="wid-id-1">
                    <header>
                        ...
                        <h2>
                            <spring:message code="mihabitat.reportes.pagos.departamento" />
                        </h2>
                    </header>
                    <div>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="row">
                                            <div class="col col-md-2">
                                                <label class="label">
                                                    <spring:message code="mihabitat.reportes.pagos.departamento.anio" />
                                                </label>
                                                <label class="select">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
	                            <table id="table-meses" class="table table-striped table-bordered table-hover" style="width: 100%">
	                                <thead>
	                                    <tr>
	                                        <th data-hide="phone"><spring:message code="mihabitat.departamento" /></th>
                                            <th data-hide="phone"><spring:message code="mihabitat.departamento.etiquetas" /></th>
	                                        <th><spring:message code="mihabitat.reportes.pagos.departamento.total" /></th>
    ...
    <script src="${pageContext.request.contextPath}/recursos/js/app/reportes/pagos-departamento-app.js?v=${project-version}"></script>
    <script type="text/javascript">
        $(function() {
            var viewModel = new PagosDepartamentoViewModel();
