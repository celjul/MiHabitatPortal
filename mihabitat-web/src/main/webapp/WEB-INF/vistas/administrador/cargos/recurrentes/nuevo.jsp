...
<body>
	<div id="ribbon">
		<ol class="breadcrumb">
			...
			<li><a
				href="${pageContext.request.contextPath}/administrador/cargos-recurrentes/lista">
					<spring:message code="mihabitat.menu.cargos.recurrentes" />
			</a></li>
			<li><a
				href="${pageContext.request.contextPath}/administrador/cargos-recurrentes/nuevo">
    ...
    <script type="text/javascript">
        $(function() {
            var viewModel = new CargoRecurrenteViewModel({
                ...
                cargo : {
                    activo : true,
                    mantenimientoDepartamento : false,
                    primerDiaMes : true,
                    ultimoDiaMes : false,
                    seleccionarDiaMes : false,
                    monto : 0,
                    todos : false,
                    tipoRecurrente: 'com.bstmexico.mihabitat.cargos.model.CargoRecurrenteMantenimiento'
                },
