 ...
 */
@Entity
@DiscriminatorValue("cargo_cfdi")
public class MovimientoCfdi extends Movimiento {
	...
	@JsonIgnoreProperties(value = { "movimientoCfdi" })
	@JoinColumn(name = "NIdDetalleMovimientoCfdi", nullable = true, referencedColumnName = "NIdConcepto")
	@OneToOne(fetch = FetchType.LAZY)
	private DetalleFactura detalleCfdi;
	...
	public DetalleFactura getDetalleCfdi() {
		return detalleCfdi;
	}

	public void setDetalleCfdi(DetalleFactura detalleCfdi) {
		this.detalleCfdi = detalleCfdi;
	}
